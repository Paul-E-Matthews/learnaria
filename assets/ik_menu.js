;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_menu',
		defaults = {
			'instructions': 'Use arrow keys to navigate between menu items, space bar to expand sub menus, escape key to close sub menus, enter to activate menu items.'
		};
	...
	Plugin.prototype.init = function () {
		...
		plugin.menuitems = $elem.find('li') // setup menuitems
			...
			.each(function(i, el) {
				...
				$me.attr({
					'role': 'menuitem', // assign menuitem role
